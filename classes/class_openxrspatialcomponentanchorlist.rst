...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Tự động tạo từ mã nguồn của Godot engine. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/modules/openxr/doc_classes/OpenXRSpatialComponentAnchorList.xml.
...
Đối tượng dùng để lưu trữ dữ liệu kết quả anchor của các truy vấn.
...
Đối tượng dùng để lưu trữ dữ liệu kết quả anchor của các truy vấn khi gọi :ref:`OpenXRSpatialEntityExtension.query_snapshot()<class_OpenXRSpatialEntityExtension_method_query_snapshot>`.
...
Trả về transform của entity tại ``index``.
