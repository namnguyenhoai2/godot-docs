...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của engine Godot. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/PhysicsDirectBodyState3DExtension.xml.
...
**Kế thừa:** :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` **<** :ref:`Object<class_Object>`

Cung cấp các phương thức virtual có thể được ghi đè để tạo các triển khai :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` tùy chỉnh.
...
Lớp này mở rộng :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` bằng cách cung cấp các phương thức virtual bổ sung có thể được ghi đè. Khi các phương thức này được ghi đè, chúng sẽ được gọi thay cho các phương thức nội bộ của physics server.

Dùng với GDExtension để tạo các triển khai :ref:`PhysicsDirectBodyState3D<class_PhysicsDirectBodyState3D>` tùy chỉnh.
