...
Khi **AnimatableBody2D** được di chuyển, vận tốc tuyến tính và vận tốc góc của nó được ước tính và dùng để tác động đến các physics body khác trên đường đi của nó. Điều này khiến nó hữu ích cho các nền tảng chuyển động, cửa và những đối tượng chuyển động khác.
...
Nếu ``true``, chuyển động của body sẽ được đồng bộ với khung hình physics. Điều này hữu ích khi animate chuyển động thông qua :ref:`AnimationPlayer<class_AnimationPlayer>`, chẳng hạn như trên các nền tảng chuyển động. **Không** sử dụng cùng với :ref:`PhysicsBody2D.move_and_collide()<class_PhysicsBody2D_method_move_and_collide>`.
