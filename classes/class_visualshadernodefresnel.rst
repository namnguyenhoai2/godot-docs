...
Hiệu ứng Fresnel được sử dụng trong visual shader graph.
...
Trả về độ suy giảm dựa trên tích vô hướng của pháp tuyến bề mặt và hướng nhìn của camera (truyền các đầu vào liên quan vào đó).
