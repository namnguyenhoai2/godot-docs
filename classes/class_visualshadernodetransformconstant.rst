...
Một :ref:`Transform3D<class_Transform3D>` hằng số để sử dụng trong đồ thị visual shader.
...
Một hằng số :ref:`Transform3D<class_Transform3D>`, có thể được sử dụng làm node đầu vào.
...
Một hằng số :ref:`Transform3D<class_Transform3D>` biểu thị trạng thái của node này.
