...
Trả về khoảng cách giữa hai điểm. Được sử dụng trong visual shader graph.
...
Tính khoảng cách từ điểm được biểu diễn bởi vector ``p0`` đến vector ``p1``.

Được dịch thành ``distance(p0, p1)`` trong ngôn ngữ shader.
