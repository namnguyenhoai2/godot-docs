...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn engine Godot. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/PhysicsServer3DExtension.xml.
...
**Kế thừa:** :ref:`PhysicsServer3D<class_PhysicsServer3D>` **<** :ref:`Object<class_Object>`

Cung cấp các phương thức virtual có thể được override để tạo các implementation tùy chỉnh của :ref:`PhysicsServer3D<class_PhysicsServer3D>`.
...
Class này mở rộng :ref:`PhysicsServer3D<class_PhysicsServer3D>` bằng cách cung cấp thêm các phương thức virtual có thể được override. Khi các phương thức này được override, chúng sẽ được gọi thay cho các phương thức nội bộ của physics server.

Dùng với GDExtension để tạo các implementation tùy chỉnh của :ref:`PhysicsServer3D<class_PhysicsServer3D>`.
