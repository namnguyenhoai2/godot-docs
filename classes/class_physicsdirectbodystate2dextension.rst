...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của Godot engine. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/PhysicsDirectBodyState2DExtension.xml.
...
**Kế thừa:** :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` **<** :ref:`Object<class_Object>`

Cung cấp các virtual method có thể được ghi đè để tạo các triển khai :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` tùy chỉnh.
...
Lớp này mở rộng :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` bằng cách cung cấp thêm các virtual method có thể được ghi đè. Khi các method này được ghi đè, chúng sẽ được gọi thay cho các method nội bộ của physics server.

Được dùng với GDExtension để tạo các triển khai :ref:`PhysicsDirectBodyState2D<class_PhysicsDirectBodyState2D>` tùy chỉnh.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.add_constant_central_force()<class_PhysicsDirectBodyState2D_method_add_constant_central_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.add_constant_force()<class_PhysicsDirectBodyState2D_method_add_constant_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.add_constant_torque()<class_PhysicsDirectBodyState2D_method_add_constant_torque>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_central_force()<class_PhysicsDirectBodyState2D_method_apply_central_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_central_impulse()<class_PhysicsDirectBodyState2D_method_apply_central_impulse>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_force()<class_PhysicsDirectBodyState2D_method_apply_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_impulse()<class_PhysicsDirectBodyState2D_method_apply_impulse>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_torque()<class_PhysicsDirectBodyState2D_method_apply_torque>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.apply_torque_impulse()<class_PhysicsDirectBodyState2D_method_apply_torque_impulse>`.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.angular_velocity<class_PhysicsDirectBodyState2D_property_angular_velocity>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.center_of_mass<class_PhysicsDirectBodyState2D_property_center_of_mass>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.center_of_mass_local<class_PhysicsDirectBodyState2D_property_center_of_mass_local>` và getter tương ứng của nó.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_constant_force()<class_PhysicsDirectBodyState2D_method_get_constant_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_constant_torque()<class_PhysicsDirectBodyState2D_method_get_constant_torque>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider()<class_PhysicsDirectBodyState2D_method_get_contact_collider>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider_id()<class_PhysicsDirectBodyState2D_method_get_contact_collider_id>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider_object()<class_PhysicsDirectBodyState2D_method_get_contact_collider_object>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider_position()<class_PhysicsDirectBodyState2D_method_get_contact_collider_position>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider_shape()<class_PhysicsDirectBodyState2D_method_get_contact_collider_shape>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_collider_velocity_at_position()<class_PhysicsDirectBodyState2D_method_get_contact_collider_velocity_at_position>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_count()<class_PhysicsDirectBodyState2D_method_get_contact_count>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_impulse()<class_PhysicsDirectBodyState2D_method_get_contact_impulse>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_local_normal()<class_PhysicsDirectBodyState2D_method_get_contact_local_normal>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_local_position()<class_PhysicsDirectBodyState2D_method_get_contact_local_position>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_local_shape()<class_PhysicsDirectBodyState2D_method_get_contact_local_shape>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_contact_local_velocity_at_position()<class_PhysicsDirectBodyState2D_method_get_contact_local_velocity_at_position>`.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.inverse_inertia<class_PhysicsDirectBodyState2D_property_inverse_inertia>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.inverse_mass<class_PhysicsDirectBodyState2D_property_inverse_mass>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.linear_velocity<class_PhysicsDirectBodyState2D_property_linear_velocity>` và getter tương ứng của nó.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_space_state()<class_PhysicsDirectBodyState2D_method_get_space_state>`.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.step<class_PhysicsDirectBodyState2D_property_step>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.total_angular_damp<class_PhysicsDirectBodyState2D_property_total_angular_damp>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.total_gravity<class_PhysicsDirectBodyState2D_property_total_gravity>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.total_linear_damp<class_PhysicsDirectBodyState2D_property_total_linear_damp>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.transform<class_PhysicsDirectBodyState2D_property_transform>` và getter tương ứng của nó.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.get_velocity_at_local_position()<class_PhysicsDirectBodyState2D_method_get_velocity_at_local_position>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.integrate_forces()<class_PhysicsDirectBodyState2D_method_integrate_forces>`.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.sleeping<class_PhysicsDirectBodyState2D_property_sleeping>` và getter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.angular_velocity<class_PhysicsDirectBodyState2D_property_angular_velocity>` và setter tương ứng của nó.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.set_constant_force()<class_PhysicsDirectBodyState2D_method_set_constant_force>`.
...
Phiên bản có thể ghi đè của :ref:`PhysicsDirectBodyState2D.set_constant_torque()<class_PhysicsDirectBodyState2D_method_set_constant_torque>`.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.linear_velocity<class_PhysicsDirectBodyState2D_property_linear_velocity>` và setter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.sleeping<class_PhysicsDirectBodyState2D_property_sleeping>` và setter tương ứng của nó.
...
Triển khai để ghi đè hành vi của :ref:`PhysicsDirectBodyState2D.transform<class_PhysicsDirectBodyState2D_property_transform>` và setter tương ứng của nó.
