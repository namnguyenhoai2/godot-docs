...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của Godot engine. .. Trình tạo: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. Nguồn XML: https://github.com/godotengine/godot/tree/master/modules/openxr/doc_classes/OpenXRSpatialComponentBounded2DList.xml.
...
Đối tượng dùng để lưu trữ dữ liệu kết quả bounded2d của các truy vấn.
...
Đối tượng dùng để lưu trữ dữ liệu kết quả hình chữ nhật bao quanh 2D của các truy vấn khi gọi :ref:`OpenXRSpatialEntityExtension.query_snapshot()<class_OpenXRSpatialEntityExtension_method_query_snapshot>`.
...
Trả về tâm của hình chữ nhật bao quanh cho thực thể tại ``index`` này.
...
Trả về kích thước của hình chữ nhật bao quanh cho thực thể tại ``index`` này.
