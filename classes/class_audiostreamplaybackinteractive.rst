...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tạo tự động từ mã nguồn engine Godot. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/modules/interactive_music/doc_classes/AudioStreamPlaybackInteractive.xml.
...
Thành phần phát lại của :ref:`AudioStreamInteractive<class_AudioStreamInteractive>`.
...
Thành phần phát lại của :ref:`AudioStreamInteractive<class_AudioStreamInteractive>`. Chứa các hàm để thay đổi clip hiện đang phát.
...
Trả về chỉ mục của clip đang phát. Bạn có thể dùng giá trị này để lấy tên của clip đang phát với :ref:`AudioStreamInteractive.get_clip_name()<class_AudioStreamInteractive_method_get_clip_name>`.

\ **Ví dụ:** Lấy tên clip đang phát từ bên trong một node :ref:`AudioStreamPlayer<class_AudioStreamPlayer>`.
