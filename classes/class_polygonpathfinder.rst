...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của Godot engine. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/PolygonPathFinder.xml.
...
.. container:: contribute
	...
	Hiện chưa có mô tả cho class này. Hãy giúp chúng tôi bằng cách `contributing one <https://contributing.godotengine.org/en/latest/documentation/class_reference.html>`__!
...
.. tabs::
 ...
 .. code-tab:: csharp
    ...
    GD.Print(polygonPathFinder.IsPointInside(new Vector2(1.0f, 1.0f))); // In False
...
Thiết lập **PolygonPathFinder** với một mảng các điểm xác định các đỉnh của đa giác và một mảng chỉ số xác định các cạnh của đa giác.

Độ dài của ``connections`` phải là số chẵn; nếu là số lẻ thì sẽ trả về lỗi.
