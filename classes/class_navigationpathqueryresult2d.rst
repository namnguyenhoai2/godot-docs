...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của Godot engine. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/NavigationPathQueryResult2D.xml.
...
Đại diện cho kết quả của một truy vấn tìm đường 2D.
...
Class này lưu trữ kết quả của một truy vấn đường đi navigation 2D từ :ref:`NavigationServer2D<class_NavigationServer2D>`.
...
Đoạn đường này đi qua một region.
...
Đoạn đường này đi qua một link.
...
- |void| **set_path**\ (\ value\: :ref:`PackedVector2Array<class_PackedVector2Array>`\ ) - :ref:`PackedVector2Array<class_PackedVector2Array>` **get_path**\ (\ )

Mảng path kết quả từ truy vấn navigation. Tất cả vị trí trong mảng path đều sử dụng tọa độ global. Nếu không tùy chỉnh các tham số truy vấn, đây là cùng path được trả về bởi :ref:`NavigationServer2D.map_get_path()<class_NavigationServer2D_method_map_get_path>`.

**Lưu ý:** Mảng được trả về là một bản *sao chép* và mọi thay đổi đối với nó sẽ không cập nhật giá trị property ban đầu. Xem :ref:`PackedVector2Array<class_PackedVector2Array>` để biết thêm chi tiết.
...
**Lưu ý:** Mảng được trả về là một bản *sao chép* và mọi thay đổi đối với nó sẽ không cập nhật giá trị property ban đầu. Xem :ref:`PackedInt64Array<class_PackedInt64Array>` để biết thêm chi tiết.
...
**Lưu ý:** Mảng được trả về là một bản *sao chép* và mọi thay đổi đối với nó sẽ không cập nhật giá trị property ban đầu. Xem :ref:`PackedInt32Array<class_PackedInt32Array>` để biết thêm chi tiết.
...
Đặt lại result object về trạng thái ban đầu. Điều này hữu ích khi tái sử dụng object cho nhiều truy vấn.
