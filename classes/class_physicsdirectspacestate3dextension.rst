...
.. KHÔNG ĐƯỢC CHỈNH SỬA TỆP NÀY!!! .. Được tự động tạo từ mã nguồn của Godot engine. .. Generator: https://github.com/godotengine/godot/tree/master/doc/tools/make_rst.py. .. XML source: https://github.com/godotengine/godot/tree/master/doc/classes/PhysicsDirectSpaceState3DExtension.xml.
...
**Kế thừa:** :ref:`PhysicsDirectSpaceState3D<class_PhysicsDirectSpaceState3D>` **<** :ref:`Object<class_Object>`

Cung cấp các phương thức virtual có thể được override để tạo các triển khai :ref:`PhysicsDirectSpaceState3D<class_PhysicsDirectSpaceState3D>` tùy chỉnh.
...
Lớp này mở rộng :ref:`PhysicsDirectSpaceState3D<class_PhysicsDirectSpaceState3D>` bằng cách cung cấp thêm các phương thức virtual có thể được override. Khi các phương thức này được override, chúng sẽ được gọi thay cho các phương thức nội bộ của physics server.

Dùng với GDExtension để tạo các triển khai tùy chỉnh của :ref:`PhysicsDirectSpaceState3D<class_PhysicsDirectSpaceState3D>`.
